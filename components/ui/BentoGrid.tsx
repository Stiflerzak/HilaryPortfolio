...
export const BentoGridItem = ({
  ...
  spareImg?: string;
    ...
    const handleCopy = () => {
        const text= "hilarymwendia97@gmail.com";
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(53,67,119,1) 57%, rgba(110,103,154,1) 100%, rgba(44,43,106,1) 100%)",
      }}
    >
      {/* contains imgs in the card grid */}
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        <div
          className={cn(
            titleClassName,
            "group-hover/ bento: translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 llg:p-10"
          )}
        >
